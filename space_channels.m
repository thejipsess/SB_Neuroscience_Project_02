function Wn = space_channels(n_channels, Fs, channel_spacing)
    ...
    switch channel_spacing
        ...
        case 'log'
            % Create a list of all cutoff frequencies for the bandpass filters
            cf = transpose(repmat(logspace(log10(188), log10(7938), n_channels+1), 1, 1));
        ...
        case '22-electrodes_reverse'
            % Create a list of all cutoff frequencies for the bandpass filters
            cf = [188;1187;2063;2813;3438;4063;4563;5063;5538;5813;6063;6313;6558;6813;6938;7063;7188;7313;7438;7563;7688;7813;7938];
